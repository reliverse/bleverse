      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            <a href="https://bleverse.com" className="flex flex-col items-center gap-2 font-medium">
              <div className="flex h-8 w-8 items-center justify-center rounded-md">
                <RiGalleryView className="size-6" />
              </div>
              <span className="sr-only">Bleverse</span>
            </a>
            <h1 className="text-xl font-bold">Welcome back to Bleverse</h1>
          </div>
