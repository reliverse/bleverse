...
export const projects: Project[] = [
  {
    ...
    shortDescription:
      "Personal website of Nazar Kornienko, the lead developer behind the Bleverse ecosystem.",
    heroImage: "/placeholder.svg?height=600&width=1200",
    body: `Blefnk is the personal website and portfolio of Nazar Kornienko, the visionary developer behind the entire Bleverse ecosystem. The site showcases his work, thoughts, and contributions to the open-source community.

Nazar has been instrumental in building all Bleverse products, from concept to deployment, with a focus on modern web technologies and user experience.`,
...
Features include project scaffolding, deployment automation, AI assistance, and integration with the broader Reliverse ecosystem.`,
    externalLink: "https://docs.reliverse.org/libraries/rse",
    category: "developer",
    status: "beta",
  },
  {
...
Features include zero-config setup, TypeScript support, bundling, testing, publishing helpers, and documentation generation.`,
    externalLink: "https://docs.reliverse.org/libraries/dler",
    category: "developer",
    status: "live",
  },
  {
