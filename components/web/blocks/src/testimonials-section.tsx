...
const testimonials = [
  ...
  },
  {
    id: 2,
    content:
      "The attention to detail in every Bleverse product is remarkable. Their ecosystem approach means everything works together seamlessly.",
    author: "Lydie Orris",
    role: "Lead Developer",
  ...
  },
  {
    id: 4,
    content:
      "The Bleverse platform is a really good thing. The integration capabilities are exactly what we needed.",
    author: "Anaїs",
