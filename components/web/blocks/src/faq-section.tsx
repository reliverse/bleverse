...
const faqs = [
  {
    question: "What technologies does Bleverse specialize in?",
    answer:
  ...
  {
    question: "Are Bleverse products open source?",
    answer:
  ...
  {
    question: "How can I contribute to Bleverse projects?",
    answer:
  ...
  {
    question: "What is the Bleverse ecosystem?",
    answer:
      "The Bleverse ecosystem is a collection of interconnected digital products spanning multiple domains including developer tools, social platforms, commerce solutions, entertainment, and lifestyle applications. All products are designed to work together seamlessly.",
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Everything you need to know about Bleverse and our products
          </p>
        </div>
