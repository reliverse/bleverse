...
UNITS=(
  bun-web-4000-bleverse.service
  bun-api-4001-bleverse.service
  bun-router-4002-bleverse-preview.service
)
...
HEALTH_URLS=(
  ...
  "https://bleverse.com/health"
  "https://api.bleverse.com/health"
)
